...
- the Worker now has a durable, editor-owned 8 MiB multipart intake for new private Recording originals, including resumable server-held part state, crash-safe R2 completion, streaming SHA-256 verification, and exact-content duplicate stopping; no browser upload form, Recording/media/job finalization, or cloud deployment is included yet;
